                ...
                <div className='flex items-center justify-between pb-4'>
                    <div className="pb-4 bg-white dark:bg-gray-900">
                        ...
                        <div className="relative mt-1">
                            ...
                            <input type="text" id="tableSearch" onKeyUp={tableSearch} className="block p-2 pl-10 text-sm text-darkSeaGreen border border-gray-300 rounded-lg w-80 bg-gray-50 focus:ring-darkSeaGreen focus:border-darkSeaGreen dark:bg-darkGreen dark:border-darkGreen dark:placeholder-darkSeaGreen dark:text-white dark:focus:ring-blue-500 dark:focus:border-darkSeaGreen" placeholder="Search for items" />
                        </div>
                    </div>
                    <div>
                        <button type="button"
