    ...
    return (
            <div class="relative shadow-md sm:rounded-lg">
                <div className='flex items-center justify-between pb-4'>
                    <div class="pb-4 bg-white dark:bg-gray-900">
                        ...
                        <div class="relative mt-1">
                            ...
                            <input type="text" id="tableSearch" onKeyUp={tableSearch} class="block p-2 pl-10 text-sm text-gray-900 border border-gray-300 rounded-lg w-80 bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Search for items" />
                        </div>
                    </div>
                    <div>
                        <button type="button"
                ...
                <div className='overflow-x-auto '>
                    <table id='roomTypesDTbl' class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        ...
                        <tbody>
                            {
                                getAllRoomTypes.map(items => (
                                    <tr key={items.id} class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                        <th scope="row" class="px-6 py-4 whitespace-nowrap font-medium text-gray-900 dark:text-white">
                    ...
                    <div className="space-y-6" action="#">
                        <div className='flex flex-row justify-between'>
                            <div className=' basis-1/2'>
                                <div class="relative">
                                    <input type="text" id="fo_roomTypeId" class="block px-2.5 pb-2.5 pt-4 w-full text-sm text-gray-900 bg-transparent rounded-lg border-1 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " onChange={ e => { setRoomTypeId(e.target.value) }} />
                        ...
                        <div className='flex flex-row justify-between gap-5'>
                            <div className='basis-1/2'>
                            <div class="relative">
                                    <input type="text" id="fo_roomTypeName" class="block px-2.5 pb-2.5 pt-4 w-full text-sm text-gray-900 bg-transparent rounded-lg border-1 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " onChange={ e => { setRoomTypeName(e.target.value) }}  />
                                    <label for="fo_roomTypeName" class="absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-4 scale-75 top-2 z-10 origin-[0] bg-white dark:bg-gray-900 px-2 peer-focus:px-2 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:top-1/2 peer-focus:top-2 peer-focus:scale-75 peer-focus:-translate-y-4 left-1">Name</label>
                                </div>
                            </div>

                            <div className='basis-1/2'>
                            <div class="relative">
                                    <input type="text" id="fo_roomTypeDesc" class="block px-2.5 pb-2.5 pt-4 w-full text-sm text-gray-900 bg-transparent rounded-lg border-1 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " onChange={ e => { setRoomTypeDesc(e.target.value) }} />
                                    <label for="fo_roomTypeDesc" class="absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-4 scale-75 top-2 z-10 origin-[0] bg-white dark:bg-gray-900 px-2 peer-focus:px-2 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:top-1/2 peer-focus:top-2 peer-focus:scale-75 peer-focus:-translate-y-4 left-1">Description</label>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className='flex flex-row justify-between gap-5'>
                            <div className='basis-1/2'>
                                <div class="relative">
                                    <input type="text" id="fo_roomTypeSize" class="block px-2.5 pb-2.5 pt-4 w-full text-sm text-gray-900 bg-transparent rounded-lg border-1 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " onChange={ e => { setRoomTypeSize(e.target.value) }} />
                                    <label for="fo_roomTypeSize" class="absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-4 scale-75 top-2 z-10 origin-[0] bg-white dark:bg-gray-900 px-2 peer-focus:px-2 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:top-1/2 peer-focus:top-2 peer-focus:scale-75 peer-focus:-translate-y-4 left-1">Room Size</label>
                                </div>
                            </div>

                            <div className='basis-1/2'>
                                <div class="relative">
                                    <input type="text" id="fo_roomTypePrice" class="block px-2.5 pb-2.5 pt-4 w-full text-sm text-gray-900 bg-transparent rounded-lg border-1 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " onChange={ e => { setRoomTypePrice(e.target.value) }} />
                                    <label for="fo_roomTypePrice" class="absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-4 scale-75 top-2 z-10 origin-[0] bg-white dark:bg-gray-900 px-2 peer-focus:px-2 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:top-1/2 peer-focus:top-2 peer-focus:scale-75 peer-focus:-translate-y-4 left-1">Room Price</label>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className='flex flex-row justify-between gap-5'>
                            <div className='basis-1/2'>
                                <div class="relative">
                                    <input type="text" id="fo_roomTypeCapacity" class="block px-2.5 pb-2.5 pt-4 w-full text-sm text-gray-900 bg-transparent rounded-lg border-1 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " onChange={ e => { setRoomTypeCapacity(e.target.value) }} />
                                    <label for="fo_roomTypeCapacity" class="absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-4 scale-75 top-2 z-10 origin-[0] bg-white dark:bg-gray-900 px-2 peer-focus:px-2 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:top-1/2 peer-focus:top-2 peer-focus:scale-75 peer-focus:-translate-y-4 left-1">Room Capacity</label>
                                </div>
                            </div>
                        </div>
                ...
                <div className="space-y-6" action="#">
                    ...
                    <div className='flex flex-row justify-between gap-5'>
                        <div className='basis-1/2'>
                            <div class="relative">
                                <input type="text" id="fo_roomTypeDescription" class="block px-2.5 pb-2.5 pt-4 w-full text-sm text-gray-900 bg-transparent rounded-lg border-1 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" value={roomTypeDesc} onChange={ e => { setRoomTypeDesc(e.target.value) }}  />
                                <label for="fo_roomTypeDescription" class="absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-4 scale-75 top-2 z-10 origin-[0] bg-white dark:bg-gray-900 px-2 peer-focus:px-2 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:top-1/2 peer-focus:top-2 peer-focus:scale-75 peer-focus:-translate-y-4 left-1">Room Type Description</label>
                            </div>
                        </div>

                        <div className='basis-1/2'>
                            <div class="relative">
                                <input type="text" id="fo_roomTypeSize" class="block px-2.5 pb-2.5 pt-4 w-full text-sm text-gray-900 bg-transparent rounded-lg border-1 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" value={roomTypeSize} onChange={ e => { setRoomTypeSize(e.target.value) }} />
                    ...
                    <div className='flex flex-row justify-between gap-5'>
                        <div className='basis-1/2'>
                            <div class="relative">
                                <input type="text" id="fo_roomTypePrice" class="block px-2.5 pb-2.5 pt-4 w-full text-sm text-gray-900 bg-transparent rounded-lg border-1 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" value={roomTypePrice} onChange={ e => { setRoomTypePrice(e.target.value) }} />
                        ...
                        <div className='basis-1/2'>
                            <div class="relative">
                                <input type="text" id="fo_roomTypeCapacity" class="block px-2.5 pb-2.5 pt-4 w-full text-sm text-gray-900 bg-transparent rounded-lg border-1 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" value={roomTypeCapacity} onChange={ e => { setRoomTypeCapacity(e.target.value) }} />
