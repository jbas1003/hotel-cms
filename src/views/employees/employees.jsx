...
const Employees = () => {
    ...
    const getEmployees = () => {
        ...
        .then(result => setGetAllEmployees(result))
            ...
            <div className="relative shadow-md sm:rounded-lg">
                ...
                <div className='overflow-x-auto'>
                    <table id='employeeDTbl' className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        ...
                        <tbody>
                            { 
                                getAllEmployees.status === 200 ?
                                    getAllEmployees.body.map((items) => (
                                    ...
                                    :
                                        <tr>
                                            <td colSpan={6} align="center" className='text-3xl'>No Records Found...</td>
                                        </tr>
                            }
                        </tbody>
                    </table>
        ...
        <ModalAdd show={showAddEmployee} setShow={setShowAddEmployee}>
            <div className="space-y-6" action="#">
                ...
                <div className='basis-1/2'>
                    ...
                    <div className='basis-1/2'>
                        <div className="relative">
                            <input type="password" id="fo_password" className="block px-2.5 pb-2.5 pt-4 w-full text-sm text-gray-900 bg-transparent rounded-lg border-1 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " onChange={ e => { setPassword(e.target.value) }} />
